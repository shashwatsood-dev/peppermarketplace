...
export const advancedRequisitions: AdvancedRequisition[] = [
  {
    ...
    hiringData: {
      ...
      studioType: "Hybrid",
      geography: "India",
      signingEntity: "Pepper Content Global Private Limited",
      talentType: "",
      ...
      lineItems: [
        {
          ...
          clientUnitPrice: 3.5, targetUnitMargin: 40, supplyUnitPay: 2.1, isCombinedPay: false, pricingMode: "client-to-supply",
        ...
        },
        {
          ...
          clientUnitPrice: 0, targetUnitMargin: 40, supplyUnitPay: 0, isCombinedPay: false, pricingMode: "client-to-supply",
      ...
      lineItems: [
        {
          ...
          clientUnitPrice: 5.8, targetUnitMargin: 40, supplyUnitPay: 3.48, isCombinedPay: false, pricingMode: "client-to-supply",
        ...
        },
        {
          ...
          clientUnitPrice: 5500, targetUnitMargin: 40, supplyUnitPay: 3300, isCombinedPay: false, pricingMode: "client-to-supply",
      ...
      lineItems: [
        {
          ...
          clientUnitPrice: 4.7, targetUnitMargin: 45, supplyUnitPay: 2.585, isCombinedPay: false, pricingMode: "client-to-supply",
