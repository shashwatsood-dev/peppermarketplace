...
function makeDeal(id: string, name: string, type: string, status: DealStatus, creators: DeployedCreatorV2[]): DealV2 {
    ...
    clients: [
      {
        ...
        deals: [
          makeDeal("D-003", "Customer Success Content", "Retainer", "Active", [
      ...
      },
      {
        ...
        deals: [
          makeDeal("D-004", "Investment Education Series", "Retainer", "Active", [
    ...
    clients: [
      {
        ...
        deals: [
          makeDeal("D-005", "SaaS Blog Overhaul", "Project", "Active", [
    ...
    clients: [
      {
        ...
        deals: [
          makeDeal("D-006", "Brand Storytelling", "Project", "Active", [
    ...
    clients: [
      {
        ...
        deals: [
          makeDeal("D-007", "Digital Banking Content", "Retainer", "Active", [
...
export function updateDeal(dealId: string, updates: Partial<Pick<DealV2, "dealName" | "dealType" | "status" | "totalContractValue">>) {
  pods = pods.map(p => ({
    ...p,
    clients: p.clients.map(c => ({
      ...c,
      deals: c.deals.map(d => d.id === dealId ? { ...d, ...updates } : d),
    })),
  }));
}
...
export function addCreatorToDeal(dealId: string, creator: Omit<DeployedCreatorV2, "id" | "grossMargin" | "grossMarginPercent">) {
